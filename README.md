...
1 - Для OR хватило 4 эпохи, с пятой эпохи вычисления выполнялись корректно: 
...
2 - Для AND хватило 6 эпох, с седьмой эпохи вычисления выполнялись корректно:
...
3 - Для NAND хватило 6 эпох, с седьмой эпохи вычисления выполнялись корректно:
